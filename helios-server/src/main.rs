...
async fn classify(
    ...
    let meters_per_pixel =
        40_075_016.686 * lat_rad.cos() / ((TILE_SIZE as f64) * f64::powi(2.0, ZOOM as i32));
    let dsm = Dsm {
        width,
        height,
        meters_per_pixel,
    ...
    let px = wx - (x0 as f64) * TILE_SIZE as f64;
    let py = wy - (y0 as f64) * TILE_SIZE as f64;
